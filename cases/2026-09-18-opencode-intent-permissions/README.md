...
**🟡 B · 效果待验证**<br>文档明确 Code Mode execute 可绕过插件。应理解为若干拦截演示，不能扩展成无法绕过的网络安全边界。<br>[判断依据与来源](../../references/2026-09-19-claims-audit.md#opencode-intent-permissions) · 2026-09-19 11:30:00 北京时间
