...
**🟡 B · 效果待验证**<br>没有标注准确率、模型对照或并发配置；吞吐量和便利性不能证明普遍优于所有 LLM。<br>[判断依据与来源](../../references/2026-09-19-claims-audit.md#duckdb) · 2026-09-19 11:30:00 北京时间
...
| 主张 | 依据类型 | 来源 | 适用范围 |
| --- | --- | --- | --- |
| 作者报告约 10 秒处理 1,000 行，未公布完整复现配置。 | 作者陈述 | [主帖正文及附带媒体](https://x.com/hamiltonulmer/status/2100370557405667768) | 本仓库未复测，演示不证明普遍性能 |
...
吞吐取决于并发、行长度和 API 限制；不能直接与单请求延迟比较。
