...
**🟡 B · Effectiveness unverified**<br>A plausible multi-instance demo with self-reported cost. Environment fidelity, batching and duration are unspecified, so it does not establish general mobile control or a matched human comparison.<br>[Assessment and sources](../../references/2026-09-19-claims-audit.en.md#subway-runners)
