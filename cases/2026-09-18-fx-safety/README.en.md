...
**🟡 B · Effectiveness unverified**<br>A self-reported safety-classifier comparison exists, but the absent dataset and false-allow rates prevent treating it as validated security enforcement.<br>[Assessment and sources](../../references/2026-09-19-claims-audit.en.md#fx-safety)
