...
| [MuJoCo two-stage control: choose a goal, then move the arm](../cases/2026-09-23-mujoco-two-stage/README.en.md) | Makes preprocessing and hierarchical control visible for comparison with single-step action selection. | No repeated grasp success, collision statistics or real-hardware results. Rendered simulation is not proof of visual control. |
| [Whale-back city: advance a survival story through choices](../cases/2026-09-23-whale-city-game/README.en.md) | Clearly separates world creation, decisions and rendering. | State, balance, valid-action checks and full costs are missing. Clip count is not a count of independently successful tasks. |
